package exp.a8081.app8081.intercepter;

import exp.a8081.app8081.Utils.HttpUtil;
...
public class Sessionintercepter extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        response.sendRedirect("http://localhost:8084/preLogin?url=localhost:8081/sysA/wel");
        return false;
    }
}
